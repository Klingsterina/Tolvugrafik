...
window.onload = function init()
{
    ...
    canvas.addEventListener("mousemove", function(e) {
        if (isMouseDown) {
            ...
            rotationY += deltaX * 0.2; // Adjust the sensitivity here
            rotationX += deltaY * 0.2; // Adjust the sensitivity her
            lastMouseX = mouseX;
            lastMouseY = mouseY;
        }
    });
    ...
    window.addEventListener("keydown", function(e){
        switch( e.keyCode ) {
            ...
            case 57:	// 9:
                view = 9;
                document.getElementById("Viewpoint").innerHTML = "9: ";
            break;
...
function render()
{
    ...
    carZPos = TRACK_RADIUS * Math.cos( radians(carDirection))
    ...
    switch( view ) {
        ...
        case 8:
            ...
            break;
        case 9:
            // Static view from on top of house (-40.0, 140.0)
